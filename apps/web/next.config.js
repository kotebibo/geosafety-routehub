...
const nextConfig = {
  ...
  async headers() {
    const ContentSecurityPolicy = `
      ...
      font-src 'self' data:;
      connect-src 'self' *.supabase.co wss://*.supabase.co https://api.mapbox.com *.ably.io wss://*.ably.io *.ably.net wss://*.ably.net *.ably-realtime.com wss://*.ably-realtime.com https://*.tile.openstreetmap.org;
