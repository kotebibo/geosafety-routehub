...
const nextConfig = {
  ...
  async headers() {
    const ContentSecurityPolicy = `
      ...
      font-src 'self' data:;
      connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.mapbox.com https://*.ably.io wss://*.ably.io https://*.ably.net wss://*.ably.net https://*.ably-realtime.com wss://*.ably-realtime.com https://*.tile.openstreetmap.org;
