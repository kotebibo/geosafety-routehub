...
export const CellRenderer = memo(
  function CellRenderer(props: CellRendererProps) {
    ...
    switch (column.column_type as ColumnType) {
      ...
      case 'person':
        return (
          <PersonCell value={props.value} onEdit={props.onEdit} onEditStart={props.onEditStart} />
        )

      case 'route':
        return (
          <RouteCell value={props.value} onEdit={props.onEdit} onEditStart={props.onEditStart} />
        )

      case 'company':
        return (
          <CompanyCell value={props.value} onEdit={props.onEdit} onEditStart={props.onEditStart} />
        )
      ...
      case 'checkbox':
        return (
          <CheckboxCell value={props.value} onEdit={props.onEdit} onEditStart={props.onEditStart} />
        )
      ...
      case 'email':
        return (
          <EmailCell value={props.value} onEdit={props.onEdit} onEditStart={props.onEditStart} />
        )
