...
import { MONDAY_COLORS, type StatusOption } from '../../../constants/statusColors'
...
export function StatusLabelEditor({
  ...
  const handleLabelChange = (index: number, newLabel: string) => {
    setOptions(prev => prev.map((opt, i) => (i === index ? { ...opt, label: newLabel } : opt)))
  }

  const handleColorChange = (index: number, newColor: string) => {
    setOptions(prev => prev.map((opt, i) => (i === index ? { ...opt, color: newColor } : opt)))
    setEditingColorIndex(null)
  }
                    ...
                    >
                      <button
                        ...
                        className={cn(
                          ...
                          'focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-monday-primary',
                          isEditingColor && 'ring-2 ring-offset-2 ring-monday-primary'
                        )}
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-border-light">
          ...
          <button
            ...
            className={cn(
              ...
              'bg-monday-primary hover:bg-[var(--monday-primary-hover)]',
