      ...
      <div className="relative w-full max-w-md bg-bg-primary rounded-lg shadow-monday-lg">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-border-light">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-h4 font-semibold text-text-primary">Save as Template</h2>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="px-6 py-6 space-y-4">
          <p className="text-sm text-text-secondary">
            Save the current board structure as a reusable template. The columns and configuration
            will be saved, but not the data.
          </p>
